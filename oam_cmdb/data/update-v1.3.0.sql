...
ADD COLUMN `create_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci,
ADD COLUMN `update_by` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci,
ADD COLUMN `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0);
